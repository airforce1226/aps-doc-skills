# -*- coding: utf-8 -*-
"""Build a styled Korean .docx from a JSON spec (docs stage of docs->ppt).

Usage:
    python build_doc.py spec.json "output v1.0.docx"

Spec format (UTF-8 JSON):
{
  "title": "보고서 제목",
  "subtitle": "부제 (선택)",
  "meta": "작성일 ... | 작성 IT전략팀  (선택)",
...
값이 "TBD" 인 셀/문구는 회색 이탤릭(미정 표시)으로 렌더링되고,
모든 run 에 noProof(맞춤법 검사 안 함)가 적용된다.
"""
import json
import sys
